...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("D:\Ds Project\Music","")
...
def Play():
    ...
    song=f'D:\Ds Project\Music\Harry Styles - As It Was (Official Video).mp3'
...
def Previous():
    ...
    temp2=f'D:\Ds Project\Music{temp2}'
...
def Next():
    ...
    temp=f'D:\Ds Project\Music{temp}'
